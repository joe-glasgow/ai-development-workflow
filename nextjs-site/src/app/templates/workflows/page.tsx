    ...
    <main className="container-max section-padding">
        ...
        <div className="text-center mb-16">
          ...
          <div className="glass rounded-lg p-6 max-w-4xl mx-auto">
            <h3 className="text-lg font-semibold text-white mb-2">Workflow Integration</h3>
        ...
        {workflows.map((workflow, workflowIndex) => (
          <div key={workflowIndex} className="mb-16 glass rounded-lg overflow-hidden">
            {/* Workflow Header */}
            <div className="p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-slate-300">{workflow.duration}</p>
                </div>
                <div>
                  <h4 className="font-semibold text-white mb-2">Team Size:</h4>
                  <p className="text-slate-300">{workflow.teamSize}</p>
                </div>
              </div>
            </div>
            ...
            {/* Workflow Phases */}
            <div className="p-8">
              <h3 className="text-2xl font-bold text-white mb-6">Workflow Phases</h3>
              <div className="space-y-6">
                {workflow.phases.map((phase, phaseIndex) => (
                  <div key={phaseIndex} className="glass rounded-lg p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-xl font-bold text-white">{phase.name}</h4>
                      <span className="bg-glass-base text-blue-200 px-3 py-1 rounded-full text-sm font-medium">
                        {phase.duration}
                      </span>
                    </div>
                    ...
                    <div>
                      <h5 className="font-semibold text-white mb-2">AI Tools & Assistance:</h5>
                      <div className="flex flex-wrap gap-2">
                        {phase.aiTools.map((tool, toolIndex) => (
                          <span 
                            key={toolIndex}
                            className="px-3 py-1 bg-glass-base text-green-200 text-sm rounded-full"
                          >
                            {tool}
                          </span>
                        ))}
        ...
        <div className="glass rounded-lg p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">🎯 Choose Your Workflow</h3>
              <p className="text-slate-300 mb-4">
                Select the workflow that best matches your project type, team size, and timeline requirements.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">🛠️ Set Up AI Tools</h3>
              <p className="text-slate-300 mb-4">
                Configure the recommended AI tools and integrations for each phase of your chosen workflow.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">📊 Track Metrics</h3>
              <p className="text-slate-300 mb-4">
                Monitor key performance indicators to measure the effectiveness of your AI-enhanced workflow.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">🔄 Iterate & Improve</h3>
              <p className="text-slate-300 mb-4">
        ...
        <div className="glass rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-slate-300">Code Quality Score</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-400 mb-2">80%</div>
              <div className="text-slate-300">Deployment Time Reduction</div>
            </div>
          </div>
