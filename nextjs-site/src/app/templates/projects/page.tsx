    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container-max section-padding">
        ...
        <div className="text-center mb-16">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 max-w-4xl mx-auto">
            <h3 className="text-lg font-semibold text-orange-900 mb-2">AI-First Development</h3>
        ...
        {projectTemplates.map((template, templateIndex) => (
          <div key={templateIndex} className="mb-16 bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            {/* Template Header */}
            ...
            <div className="p-8">
              {/* Tech Stack */}
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Tech Stack Options</h3>
                    ...
                    <div key={category}>
                      ...
                      <div className="space-y-1">
                        {technologies.map((tech, techIndex) => (
                          <div key={techIndex} className="text-sm text-gray-600 bg-gray-50 px-2 py-1 rounded">
                            {tech}
                          </div>
                        ))}
                      </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 bg-gray-50 p-4 rounded-lg">{template.useCase}</p>
              </div>

              {/* AI Assistance */}
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">AI Assistance Included</h3>
                <div className="grid md:grid-cols-2 gap-3">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a 
                  href="/sample-project"
                  className="inline-flex items-center border border-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-50 transition-colors font-medium"
                >
                  View Live Demo
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 mb-16">
          <h2 className="text-2xl font-bold text-blue-900 mb-8 text-center">Quick Start Guide</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gray-50 rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Learn the Basics</h3>
              <p className="text-gray-600 mb-4">Start with our workflow guide to understand AI-assisted development principles.</p>
              <a href="/workflow-guide" className="text-primary-600 hover:text-primary-700 font-medium">
                View Workflow Guide →
              </a>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Explore Templates</h3>
              <p className="text-gray-600 mb-4">Browse our complete template library including personas and prompts.</p>
              <a href="/templates" className="text-primary-600 hover:text-primary-700 font-medium">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Check out our live TechGear Store demo to see the results.</p>
              <a href="/sample-project" className="text-primary-600 hover:text-primary-700 font-medium">
                View Live Demo →
              </a>
            </div>
          </div>
