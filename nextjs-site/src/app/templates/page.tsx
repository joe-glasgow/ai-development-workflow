  ...
  return (
    <main className="container-max section-padding">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass rounded-lg p-8">
            <div className="flex items-center mb-6">
              <div className="bg-glass-base p-3 rounded-lg mr-4">
                <svg className="w-8 h-8 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <h2 className="text-2xl font-bold text-white">🎭 Persona Templates</h2>
            </div>
          ...
          <div className="glass rounded-lg p-8">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-500 pl-4">
                <h3 className="font-semibold text-white">Basic Web App</h3>
                <p className="text-sm text-slate-300">React/Vue/Angular with Node.js/Python/Go backend</p>
              </div>
              <div className="border-l-4 border-green-500 pl-4">
                <h3 className="font-semibold text-white">Mobile App</h3>
                <p className="text-sm text-slate-300">React Native/Flutter with cross-platform support</p>
              </div>
              <div className="border-l-4 border-green-500 pl-4">
                <h3 className="font-semibold text-white">SaaS Dashboard</h3>
                <p className="text-sm text-slate-300">Multi-tenant applications with analytics and billing</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass rounded-lg p-8">
            ...
            <div className="space-y-4">
              <div className="glass-light border border-purple-500/30 p-4 rounded-lg">
                <h3 className="font-semibold text-purple-300 mb-2">Development Prompts</h3>
              ...
              <div className="glass-light border border-purple-500/30 p-4 rounded-lg">
                <h3 className="font-semibold text-purple-300 mb-2">Design Prompts</h3>
                <ul className="text-sm text-slate-300 space-y-1">
              ...
              <div className="glass-light border border-purple-500/30 p-4 rounded-lg">
                <h3 className="font-semibold text-purple-300 mb-2">Deployment Prompts</h3>
                <ul className="text-sm text-slate-300 space-y-1">
          ...
          <div className="glass rounded-lg p-8">
            ...
            <div className="space-y-4">
              <div className="glass-light border border-orange-500/30 rounded-lg p-4">
                <h3 className="font-semibold text-orange-300 mb-2">Agile Development</h3>
                <p className="text-sm text-slate-300 mb-2">Sprint-based iterative development with AI assistance</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Sprint Planning</span>
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Daily Standups</span>
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Retrospectives</span>
                </div>
              </div>
              <div className="glass-light border border-orange-500/30 rounded-lg p-4">
                <h3 className="font-semibold text-orange-300 mb-2">Design Sprint</h3>
                <p className="text-sm text-slate-300 mb-2">5-day rapid prototyping with AI-powered design</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Problem Definition</span>
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Ideation</span>
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Prototyping</span>
                </div>
              </div>
              <div className="glass-light border border-orange-500/30 rounded-lg p-4">
                <h3 className="font-semibold text-orange-300 mb-2">Continuous Deployment</h3>
                <p className="text-sm text-slate-300 mb-2">Automated delivery pipeline with AI quality gates</p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Automated Testing</span>
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Code Quality</span>
                  <span className="px-2 py-1 bg-glass-base text-orange-200 text-xs rounded">Deployment</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 glass rounded-lg p-8 text-white">
        ...
        <div className="mt-12 glass rounded-lg p-8">
          <h2 className="text-2xl font-bold text-white mb-6">📚 Template Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="bg-glass-base p-4 rounded-lg mb-4">
              ...
              <p className="text-sm text-slate-300">Comprehensive guides for each template category with examples and best practices</p>
            </div>
            <div className="text-center">
              <div className="bg-glass-base p-4 rounded-lg mb-4">
                <svg className="w-12 h-12 text-slate-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-slate-300">Ready-to-use code snippets and configuration files for quick implementation</p>
            </div>
            <div className="text-center">
              <div className="bg-glass-base p-4 rounded-lg mb-4">
                <svg className="w-12 h-12 text-slate-300 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-slate-300">Step-by-step setup instructions to get started with any template in minutes</p>
            </div>
          </div>
        </div>
      </div>
